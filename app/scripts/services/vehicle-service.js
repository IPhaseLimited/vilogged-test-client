...
/**
 * @ngdoc service
 * @name viLoggedClientApp.vehicleService
 * @description
 * # vehicleService
 * Service in the viLoggedClientApp.
 */
angular.module('viLoggedClientApp')
  .service('vehicleService', function vehicleService($q, storageService, db, utility, syncService) {
  // AngularJS will instantiate a singleton by calling "new" on this function
  var DB_NAME = db.VEHICLE.replace(/_/, '-');
