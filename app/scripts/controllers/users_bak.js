...
angular.module('viLoggedClientApp')
  ...
  .controller('UserFormCtrl', function($scope, $state, $stateParams, $window, userService, companyDepartmentsService, toastr,
                                       $rootScope, $cookies, notificationService, alertService) {
    ...
    $scope.createUserAccount = function() {
      ...
      userService.save($scope.userProfile)
        .then(function() {
          ...
          toastr.addSuccessMessage(message);
